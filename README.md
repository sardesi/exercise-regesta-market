...
Per quanto riguarda il FE è stato utilizzato Angular, un framework basato su TypeScript, e l'applicazione in se fa utilizzo del linguaggio stesso oltre che di JavScript, HTML e CSS (nello specifico SCSS).
