...
- per quanto riguarda la pagina di lista prodotti è una pagina con una dimensione massima prefissata contenente sul lato sinistro dei filtri, e sul più ampio lato destro la lista dei prodotti. I filtri sono una form piuttosto semplice con position fixed e sono sempre visibili. Sempre nella sezione fixed è presente un pulsante per lo scrollToTop, la cui apparizione è legata all'ascolto di un evento sulla posizione della scrollbar.
