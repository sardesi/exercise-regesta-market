...
- per il routing ho utilizzato un modulo principale che carica tramite lazy loading dei sottomoduli solo quando sono effettivamente necessari. Ogni sottomodulo ha poi il proprio routing ed i propri componenti.
